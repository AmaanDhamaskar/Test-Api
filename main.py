...
#If user exists then
# add logic to fetch the user hash to get the relevant db 
#	and if document exist then relevant collection


#Each User should have a db 
#Each Class should have a db -> then each subject should have a DB.
#Each subject should also have a general DB.


#upload a list of file and give GUI to choose to ask from particular documents
# or we decide on the basis of query which document to answer from
from fastapi import File, UploadFile, FastAPI, Depends
import llama_index
from llama_index import download_loader
from pathlib import Path
